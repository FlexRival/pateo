...
>
> ⚠️ **Cambio de marca a Pateo (15-sep-2026).** KAN-74 se cerró con
> `prooffit.com`; el mismo día la app pasó a llamarse Pateo y el dominio a
> `pateo.es`. Todo lo que cita una URL pública en Play Console (política de
> privacidad, declaración de Health Connect, ruta de borrado en Data safety)
> tiene que apuntar ya a `pateo.es`, no a `prooffit.com`.
