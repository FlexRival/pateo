...
## 1. Qué necesita Pateo exactamente
...
Traducido a Pateo: en Android no se pueden consultar los pasos de días
...
exactamente Pateo. Pedir más tipos de dato de los que se usan es motivo de
