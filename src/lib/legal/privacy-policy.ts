    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          `Sin la app instalada: visita ${LEGAL_CONTACT.site}/delete-account.html o escríbenos a ${LEGAL_CONTACT.email} desde el correo de tu cuenta. Resolveremos la solicitud en un plazo máximo de 30 días.`,
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          `Without the app installed: visit ${LEGAL_CONTACT.site}/delete-account.html or write to ${LEGAL_CONTACT.email} from your account email. We will resolve the request within 30 days at most.`,
