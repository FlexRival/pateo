...
export const termsOfService: LocalizedLegalDocument = {
  es: {
    ...
    intro: [
      'Estas son las reglas de usar Pateo. Al crear una cuenta las aceptas. Son cortas a propósito.',
    ],
    sections: [
      {
        heading: '1. Qué es Pateo',
        body: [
          'Pateo es un juego. Cuenta los pasos que da tu teléfono y los convierte en progreso: niveles, duelos contra tus amigos y guerras entre clanes.',
      ...
      },
      {
        ...
        body: [
          'Pateo se puede usar gratis. La suscripción Pro es opcional y desbloquea funciones adicionales, que se describen en la propia pantalla de compra en el momento de contratarla.',
          ...
          'Borrar tu cuenta de Pateo NO cancela la suscripción. Cancélala primero en la tienda, o seguirá cobrándose.',
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          'Hacemos lo posible por que Pateo funcione, pero no garantizamos que esté disponible sin interrupciones ni libre de errores.',
      ...
      },
      {
        ...
        body: [
          'Usar Pateo implica moverse. Hazlo con cabeza: mira por dónde andas, no uses el móvil cruzando la calle y no te fuerces más de lo que tu cuerpo aguanta. No respondemos de lesiones ni accidentes derivados de la actividad física que hagas.',
  ...
  en: {
    ...
    lastUpdated: '2026-09-07',
    intro: [
      'These are the rules for using Pateo. You accept them when you create an account. They are deliberately short.',
    ],
    sections: [
      {
        heading: '1. What Pateo is',
        body: [
          'Pateo is a game. It counts the steps your phone records and turns them into progress: levels, duels against your friends and wars between clans.',
      ...
      },
      {
        ...
        body: [
          'Pateo is free to use. The Pro subscription is optional and unlocks additional features, described on the purchase screen itself at the time you subscribe.',
          ...
          'Deleting your Pateo account does NOT cancel the subscription. Cancel it in the store first, or it will keep charging you.',
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          'We do our best to keep Pateo running, but we do not guarantee it will be available without interruption or free of bugs.',
      ...
      },
      {
        heading: '7. Liability',
        body: [
          'Using Pateo means moving. Use your head: watch where you are going, do not use your phone while crossing the street, and do not push your body further than it can go. We are not liable for injuries or accidents arising from the physical activity you do.',
